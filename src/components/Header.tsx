    ...
    <header className="sticky top-0 bg-white shadow-md z-50">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white shadow-lg py-2">
          <Link href="/" className="block px-4 py-2 text-base text-gray-800 hover:bg-gray-100">Home</Link>
          <Link href="/about" className="block px-4 py-2 text-base text-gray-800 hover:bg-gray-100">About Us</Link>
          {/* Mobile Study Abroad Dropdown */}
          <div>
            <button onClick={() => setIsStudyAbroadDropdownOpen(!isStudyAbroadDropdownOpen)} className="w-full text-left px-4 py-2 text-base text-gray-800 hover:bg-gray-100 flex justify-between items-center">
              Study Abroad <span className="ml-1">{isStudyAbroadDropdownOpen ? '▲' : '▼'}</span>
            </button>
            {isStudyAbroadDropdownOpen && (
              <div className="bg-gray-50 py-1">
                <Link href="/study-abroad/uk" className="block px-8 py-2 text-sm text-gray-700 hover:bg-gray-100">Study in UK</Link>
                <Link href="/study-abroad/usa" className="block px-8 py-2 text-sm text-gray-700 hover:bg-gray-100">Study in USA</Link>
                <Link href="/study-abroad/australia" className="block px-8 py-2 text-sm text-gray-700 hover:bg-gray-100">Study in Australia</Link>
                <Link href="/study-abroad/canada" className="block px-8 py-2 text-sm text-gray-700 hover:bg-gray-100">Study in Canada</Link>
                <Link href="/study-abroad/ireland" className="block px-8 py-2 text-sm text-gray-700 hover:bg-gray-100">Study in Ireland</Link>
                <Link href="/study-abroad/new-zealand" className="block px-8 py-2 text-sm text-gray-700 hover:bg-gray-100">Study in New Zealand</Link>
                <Link href="/study-abroad/europe" className="block px-8 py-2 text-sm text-gray-700 hover:bg-gray-100">Study in Europe</Link>
              </div>
            )}
          </div>
          {/* Mobile Services Dropdown */}
          <div>
            <button onClick={() => setIsServicesDropdownOpen(!isServicesDropdownOpen)} className="w-full text-left px-4 py-2 text-base text-gray-800 hover:bg-gray-100 flex justify-between items-center">
              Services <span className="ml-1">{isServicesDropdownOpen ? '▲' : '▼'}</span>
            </button>
            {isServicesDropdownOpen && (
              <div className="bg-gray-50 py-1">
                <Link href="/services/coaching" className="block px-8 py-2 text-sm text-gray-700 hover:bg-gray-100">Coaching Services</Link>
                <Link href="/services/visa" className="block px-8 py-2 text-sm text-gray-700 hover:bg-gray-100">Visa Services</Link>
                <Link href="/services/travel-forex" className="block px-8 py-2 text-sm text-gray-700 hover:bg-gray-100">Travel & Forex</Link>
              </div>
            )}
          </div>
          <Link href="/blog" className="block px-4 py-2 text-base text-gray-800 hover:bg-gray-100">Blog</Link>
          <Link href="/testimonials" className="block px-4 py-2 text-base text-gray-800 hover:bg-gray-100">Testimonials</Link>
          <Link href="/contact" className="block px-4 py-2 text-base text-gray-800 hover:bg-gray-100">Contact Us</Link>
          <div className="px-4 py-2 space-y-2">
            <Link href="/booking" className="block w-full text-center px-3 py-1 rounded-md text-base border border-white" style={{ backgroundColor: '#08bcb4', color: 'white' }}>Book Free Counselling</Link>
            <Link href="/mock-test" className="block w-full text-center px-3 py-1 rounded-md text-base border border-white" style={{ backgroundColor: '#08bcb4', color: 'white' }}>Free Mock Test</Link>
          </div>
        </div>
      )}
    </header>
