      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-extrabold text-[#08bcb4] mb-6 text-center">
              Privacy Policy for IAEC Consultants Pvt. Ltd.
            </h1>

            <div className="prose lg:prose-xl max-w-none text-justify text-gray-700 space-y-4">
              <p>
                At IAEC Consultants, accessible from <span className="text-[#08bcb4]">www.iaecconsultants.in</span>, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that are collected and recorded by IAEC Consultants and how we use it.
              </p>
              <p>
              ...
              <h2 className="text-2xl font-bold text-[#08bcb4] mt-8 mb-4">Log Files</h2>
              <p>
                IAEC Consultants follow a standard procedure for using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services analytics. The information collected by log files includes internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is to analyze trends, administer the site, track users&apos; movements on the website, and gather demographic information.
              </p>

              <h2 className="text-2xl font-bold text-[#08bcb4] mt-8 mb-4">Cookies and Web Beacons</h2>
              <p>
              ...
              <h2 className="text-2xl font-bold text-[#08bcb4] mt-8 mb-4">Google DoubleClick DART Cookie</h2>
              <p>
                Google is one of the third-party vendors on our site. It also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to www.website.com and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL – <a href="https://policies.google.com/technologies/ads" target="_blank" rel="noopener noreferrer" className="text-[#08bcb4] hover:underline">https://policies.google.com/technologies/ads</a>
              </p>

              <h2 className="text-2xl font-bold text-[#08bcb4] mt-8 mb-4">Our Advertising Partners</h2>
              <p>
              ...
              <p>
                Google <br />
                <a href="https://policies.google.com/technologies/ads" target="_blank" rel="noopener noreferrer" className="text-[#08bcb4] hover:underline">https://policies.google.com/technologies/ads</a>
              </p>

              <h2 className="text-2xl font-bold text-[#08bcb4] mt-8 mb-4">Advertising Partners Privacy Policies</h2>
              <p>
              ...
              <h2 className="text-2xl font-bold text-[#08bcb4] mt-8 mb-4">Third Party Privacy Policies</h2>
              <p>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
              <p>
              ...
              <h2 className="text-2xl font-bold text-[#08bcb4] mt-8 mb-4">GDPR Data Protection Rights</h2>
              <p>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>The right to rectification – You has the right to request that we correct any information you believe is inaccurate. You also have the right to request that we complete the information you believe is incomplete.</li>
                <li>The right to erasure – You has the right to request that we erase your personal data, under certain conditions.</li>
                ...
                <li>The right to data portability is to request that we transfer the data that we have collected to another organization, or directly to you, under certain conditions.</li>
              </ul>
              <p>
                If you make a request, we have one month to respond to you. If you would like to exercise any of these rights, please contact us.
              </p>

              <h2 className="text-2xl font-bold text-[#08bcb4] mt-8 mb-4">Children&apos;s Information</h2>
              <p>
              ...
              <ul className="list-none space-y-2">
                <li>By email: <a href="mailto:privacy@iaecconsultants.com" className="text-[#08bcb4] hover:underline">privacy@iaecconsultants.com</a></li>
                <li>By visiting this page on our website: <a href="/contact" className="text-[#08bcb4] hover:underline">Contact Us</a></li>
                <li>By phone number: <a href="tel:+918639706102" className="text-[#08bcb4] hover:underline">+91 863 970 6102</a></li>
              </ul>
            </div>
          </div>
        </div>
