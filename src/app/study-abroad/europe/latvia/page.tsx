...
const StudyAbroadLatviaPage = () => {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative py-20 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/images/countries/latvia.jpg')" }}>
        <div className="absolute inset-0 bg-black opacity-50"></div> {/* Overlay */}
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl font-bold mb-6 leading-tight">
              Study in <span className="text-red-600">Latvia</span> - Baltic Excellence & Innovation
            </h1>
            <p className="text-xl mb-8 text-red-100">
              Affordable EU education in the heart of the Baltics. Historic cities, innovative universities, and pathways to European success at the lowest costs
            </p>
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              <span className="bg-white/20 px-4 py-2 rounded-full text-sm font-medium">🇪🇺 EU Member State</span>
              <span className="bg-white/20 px-4 py-2 rounded-full text-sm font-medium">💰 Ultra-Affordable</span>
              <span className="bg-white/20 px-4 py-2 rounded-full text-sm font-medium">🏛️ Historic Heritage</span>
              <span className="bg-white/20 px-4 py-2 rounded-full text-sm font-medium">🌲 Natural Beauty</span>
            </div>
